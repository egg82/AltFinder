...
import me.egg82.altfinder.utils.JarUtil;
import me.egg82.altfinder.utils.LogUtil;
import me.egg82.altfinder.utils.ServerIDUtil;
import me.egg82.altfinder.utils.ServerNameUtil;
...
public class BukkitBootstrap extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        concrete = new AltFinder(this);
        concrete.onLoad();
    }

    @Override
    public void onEnable() {
        GameAnalyticsErrorHandler.open(ServerIDUtil.getID(new File(getDataFolder(), "stats-id.txt")), getDescription().getVersion(), Bukkit.getVersion());
        concrete.onEnable();
    }
